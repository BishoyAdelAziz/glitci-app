...
>({
  ...
  return (
    <div className="w-full">
      ...
      <input
        type={type}
        className={`focus:border-secondary w-full rounded-lg p-4 border border-[#CFCFCF] dark:border-gray-700 outline-none placeholder:text-xs placeholder:opacity-35 transition-colors ${
