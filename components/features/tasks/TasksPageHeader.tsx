...
export default function TasksPageHeader({ isOpen, setIsOpen }: Props) {
  return (
    <div className="flex items-center justify-between">
      <div>
        <h1 className="font-bold text-3xl tracking-tight">All Tasks</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Manage, track, and optimize your team&apos;s workflow.
        </p>
      </div>
